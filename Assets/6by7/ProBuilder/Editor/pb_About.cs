...
{
	public const string RELEASE_VERSION = "2.2.4f0";
	const int REVISION_NO = 1877;
	const string BUILD_DATE = "03-01-2014";
	const string VELOCIRAPTOR_RISK = "Bergs";
	...
	public void OnGUI()
	{
		...
		GUILayout.BeginHorizontal();
			GUILayout.Label("Velociraptor Danger: ", EditorStyles.boldLabel, GUILayout.MinWidth(LABEL_WIDTH), GUILayout.MaxWidth(LABEL_WIDTH));
