...
public abstract class UIModalInputBindDialog : UIController {
    public delegate void BindFinishCall(UIModalInputBindDialog ctrl, int actionIndex, int actionKeyIndex);
